...
func main() {
  ...
  Test: divisible by %d
	...
	fmt.Println(inspectMonkeys(monkeys, 20, func(w int) int { return w / 3 }))
	fmt.Println(inspectMonkeys(monkeys, 10000, func(w int) int { return w % lcm }))
}

func inspectMonkeys(monkeys []Monkey, rounds int, op func(int) int) int {
